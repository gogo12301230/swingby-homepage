...
export default function Home() {
  ...
  const portfolioData: Project[] = [
    { titles: { KR: "Valorant CM SHINPAI MUYOU", EN: "Valorant CM SHINPAI MUYOU", JP: "Valorant CM SHINPAI MUYOU" }, roleKey: "role_shooting_3rd_assistant", cats: ["SHOOTING"], link: "https://www.youtube.com/watch?v=NrSUELYnt0s", thumbnail: "https://img.youtube.com/vi/NrSUELYnt0s/maxresdefault.jpg" },
    ...
    { titles: { KR: "그릴리-정경호 CF (Shortform)", EN: "Grilly-Jung Kyung-ho Shortform CF", JP: "Grilly-チョン・ギョンホ ショートフォーム CM" }, roleKey: "role_production", cats: ["PRODUCTION"], link: "https://youtube.com/embed/TNKk8ohUL1I", thumbnail: "https://img.youtube.com/vi/TNKk8ohUL1I/maxresdefault.jpg" },
    { titles: { KR: "KB다이렉트자동차보험-김연아 CF", EN: "KB Direct Car Insurance-Kim Yuna CF", JP: "KBダイレクト自動車保険-キム・ヨナ CM" }, roleKey: "role_production", cats: ["PRODUCTION"], link: "https://youtube.com/embed/8YOYu1gh1tI", thumbnail: "https://img.youtube.com/vi/8YOYu1gh1tI/maxresdefault.jpg" },
