...
export default function Home() {
  ...
  const t = {
    KR: {
      ...
      role_edit: "편집",
      role_on_set: "현장편집 / 색보정",
      role_drone: "드론",
      role_dit: "D.I.T",
      role_complex: "D.I.T / 편집 / 색보정",
      role_making: "메이킹 필름",
      role_production: "제작",
      role_pepsi: "현장편집 / D.I.T",
      role_color: "색보정",
      role_shooting_color: "촬영 / 색보정",
      role_total_edit: "종합편집",
      role_assistant_director: "조감독",
      role_shooting: "촬영",
      role_rough_cut: "가편집"
    },
    JP: {
      ...
      role_edit: "編集",
      role_on_set: "現場編集 / 色補正",
      role_drone: "ドローン",
      role_dit: "D.I.T",
      role_complex: "D.I.T / 編集 / 色補正",
      role_making: "メイキング映像",
      role_production: "制作",
      role_pepsi: "現場編集 / D.I.T",
      role_color: "色補正",
      role_shooting_color: "撮影 / 色補正",
      role_total_edit: "総合編集",
      role_assistant_director: "助監督",
      role_shooting: "撮影",
      role_rough_cut: "仮編集"
    },
    EN: {
      ...
      role_edit: "EDIT",
      role_on_set: "ON-SET EDIT / COLOR GRADING",
      role_drone: "DRONE",
      role_dit: "D.I.T",
      role_complex: "D.I.T / EDIT / COLOR GRADING",
      role_making: "MAKING FILM",
      role_production: "PRODUCTION",
      role_pepsi: "ON-SET EDIT / D.I.T",
      role_color: "COLOR GRADING",
      role_shooting_color: "CINEMATOGRAPHY / COLOR GRADING",
      role_total_edit: "TOTAL EDIT",
      role_assistant_director: "ASSISTANT DIRECTOR",
      role_shooting: "CINEMATOGRAPHY",
      role_rough_cut: "ROUGH CUT"
    }
  };
  ...
  const portfolioData = [
    ...
    { titles: { KR: "흥신소", EN: "Detective agency", JP: "興신소" }, roleKey: "role_complex", cats: ["D.I.T", "EDIT", "COLOR GRADING"], link: "#", thumbnail: "/흥신소.jpg" },
    ...
    <main className="min-h-screen bg-black text-white font-sans overflow-x-hidden text-center">
      ...
      <section id="expertise" className="expertise-section py-32 px-8 max-w-6xl mx-auto relative z-10 bg-black">
        ...
        <div className="grid md:grid-cols-2 lg:grid-cols-3 gap-x-16 gap-y-24 text-left">
          {["production", "creative", "shooting", "edit", "color", "dit"].map((key, idx) => (
