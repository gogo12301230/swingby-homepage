...
export default function Home() {
  ...
  const portfolioData: Project[] = [
    ...
    { titles: { KR: "숏폼드라마-이혼당한 공주님의 달콤한 재혼", EN: "Short-form Drama: Sweet Remarriage", JP: "ショートフォームドラマ-捨てられたお嬢様のスイートな彼" }, roleKey: "role_shooting", cats: ["SHOOTING"], link: "https://www.youtube.com/watch?v=UaGy-L3Ts6Q", thumbnail: "https://img.youtube.com/vi/UaGy-L3Ts6Q/maxresdefault.jpg" },
